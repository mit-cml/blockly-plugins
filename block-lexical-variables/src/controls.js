...
Blockly.Blocks['controls_forRange'] = {
  ...
  renameBound: function(boundSubstitution, freeSubstitution) {
    ...
    if (newIndexVar !== oldIndexVar) {
      ...
      const indexSubstitution = Blockly.Substitution.simpleSubstitution(oldIndexVar, newIndexVar);
  ...
  renameFree: function(freeSubstitution) {
    ...
    const bodyFreeVars = Blockly.LexicalVariable.freeVariables(this.getInputTargetBlock('DO'));
    ...
    if (renamedBodyFreeVars.isMember(indexVar)) { // Variable capture!
      const newIndexVar = Blockly.FieldLexicalVariable.nameNotIn(indexVar, renamedBodyFreeVars.toList());
      const boundSubstitution = Blockly.Substitution.simpleSubstitution(indexVar, newIndexVar);
  ...
  freeVariables: function() { // return the free variables of this block
    const result = Blockly.LexicalVariable.freeVariables(this.getInputTargetBlock('DO'));
